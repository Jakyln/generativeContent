...
for (let index = 0; index < allSupportedColors.length; index++) {
    const color = allSupportedColors[index];
    let colorDiv = document.createElement("div");
    colorDiv.style = `height:20px;width:20px;background-color:${color}`
    colorDiv.id = color;
